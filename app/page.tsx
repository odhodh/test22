...
type AIContent = { topic: string; question: string; basic: string; advanced: string; recommendedMaterials: string; perspectiveExamples?: Record<string, string>; pathGuide?: string; reportSections?: Array<{ title: string; prompt: string; body: string }> };
